...
export const IDEA_LISTS: IdeaList[] = [
  ...
  {
    slug: "featured-episode-2",
    title: "Coming Next: Dorm & Clean Rundown",
    short: "Next Episode",
    description: "Preview of the 9 finds in tomorrow's video — dorm essentials, cleaning wins, and the storage bags that shrink your bedding to a third.",
    accent: "sky",
  },
];
...
export const PRODUCTS: Product[] = [
  ...
  {
    id: "rabbitgoo-privacy-film",
    title: "Rabbitgoo Frosted Window Privacy Film",
    blurb: "Static-cling frosted film that peels on in seconds, blocks views without blocking light, and comes off clean when you move out. Renter-safe and about the same price as a coffee.",
    priceRange: "$6-15",
    asin: "B00RDVE2L2",
    productUrl: "https://www.amazon.com/dp/B00RDVE2L2?tag=madofinds-20",
    imageUrl: "/product-images/B00RDVE2L2.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["home-improvement", "dorm-and-studio", "under-25", "featured-episode-2"],
  },
  {
    id: "no-pump-vacuum-bags",
    title: "No-Pump 3D Vacuum Storage Bags (3-pack)",
    blurb: "Self-sealing vacuum bags that suck flat with no pump — roll from one end, air whooshes out, seasonal bedding shrinks to a third its size.",
    priceRange: "$22-30",
    asin: "B0H4YN7B2M",
    productUrl: "https://www.amazon.com/dp/B0H4YN7B2M?tag=madofinds-20",
    imageUrl: "/product-images/B0H4YN7B2M.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["home-organization", "dorm-and-studio"],
  },
  {
    id: "puftem-spin-scrubber",
    title: "PUFTEM Cordless Electric Spin Scrubber",
    blurb: "Cordless spin brush with 6 replaceable heads for tub, tile, grout, and sink. Battery display so you know when to charge. The satisfying-cleaning-tok starter kit.",
    priceRange: "$25-40",
    asin: "B0D4YZY511",
    productUrl: "https://www.amazon.com/dp/B0D4YZY511?tag=madofinds-20",
    imageUrl: "/product-images/B0D4YZY511.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["cleaning-hacks"],
  },
  {
    id: "power-strip-tower",
    title: "230W Power Strip Tower with 6 Outlets + 8 USB (4 USB-C)",
    blurb: "The dorm outlet problem, solved in one purchase. Six outlets, eight USB (four USB-C), 2000J surge protection, and a footprint smaller than a shoebox.",
    priceRange: "$28-35",
    asin: "B0FF4P3WWS",
    productUrl: "https://www.amazon.com/dp/B0FF4P3WWS?tag=madofinds-20",
    imageUrl: "/product-images/B0FF4P3WWS.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["dorm-and-studio", "home-improvement"],
  },
  {
    id: "tubshroom-ultra",
    title: "TubShroom Ultra Drain Hair Catcher",
    blurb: "Stainless-steel mushroom that catches every hair before it hits the pipe. Pull it up, wipe it off, drop it back in. Ninety percent of your future plumber calls avoided.",
    priceRange: "},1-15",
    asin: "B07PB6ZX9Y",
    productUrl: "https://www.amazon.com/dp/B07PB6ZX9Y?tag=madofinds-20",
    imageUrl: "/product-images/B07PB6ZX9Y.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["cleaning-hacks", "under-25"],
  },
  {
    id: "foaming-soap-dispenser",
    title: "Automatic Foaming Soap Dispenser (Wall Mount)",
    blurb: "Wave a hand and get a perfect foam curl — four adjustable levels, wall-mount install, takes up zero counter. The 'oh, fancy' upgrade for any sink.",
    priceRange: "},8-25",
    asin: "B0CGMZQ175",
    productUrl: "https://www.amazon.com/dp/B0CGMZQ175?tag=madofinds-20",
    imageUrl: "/product-images/B0CGMZQ175.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["cleaning-hacks", "under-25"],
  },
  {
    id: "foldable-lap-desk",
    title: "Foldable Lap Desk with Storage Tray",
    blurb: "Wood laptop tray that folds flat for the closet, unfolds tall enough to actually type from your couch. Slots for the phone and the drink so you stop losing both.",
    priceRange: "$25-35",
    asin: "B0DW3K5GGQ",
    productUrl: "https://www.amazon.com/dp/B0DW3K5GGQ?tag=madofinds-20",
    imageUrl: "/product-images/B0DW3K5GGQ.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["dorm-and-studio", "under-25"],
  },
  {
    ...
    title: "Reusable Silicone Stretch Lids (7-pack)",
    blurb: "Elastic silicone rounds that stretch over any bowl, can, cup, or half-lemon in the fridge. Retire the plastic wrap once and for all.",
    priceRange: "},6-22",
    asin: "B0CHZ69ZFN",
    productUrl: "https://www.amazon.com/dp/B0CHZ69ZFN?tag=madofinds-20",
    imageUrl: "/product-images/B0CHZ69ZFN.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["small-kitchen", "under-25"],
  },
  {
    ...
    title: "Bedsure GentleSoft Fleece Throw Blanket",
    blurb: "The couch blanket you'll actually keep on the couch. Warm without being sweaty, soft without pilling, and washes without turning into a lint monster.",
    priceRange: "},8-28",
    asin: "B0CSCZM855",
    productUrl: "https://www.amazon.com/dp/B0CSCZM855?tag=madofinds-20",
    imageUrl: "/product-images/B0CSCZM855.jpg",
    videoId: "",
    videoUrl: "",
    listSlugs: ["dorm-and-studio", "under-25"],
  },
